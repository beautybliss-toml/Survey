...
module.exports = (app) => {
  ...
  router1.get("/excel", reviewController.sendExcel)
  ...
  router2.get("/insertOne1", userController.insertOne1);
  ...
  router3.post(
    "/create_or_update",
    requireAuth,
    storeController.createOrUpdate
  );
  ...
  router5.post("/copyquestion", papersettingController.copyquestion);
  ...
  router6.post("/clonesetting", requireAuth, groupController.clone);
